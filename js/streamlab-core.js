  ...
  var registerDependencies = function () {
      ...
      jQuery(".slider-nav").each(function () {
        ...
        jQuery(".slider-nav")
          ...
          .slick({
            ...
            centerMode: true,
            prevArrow:
              '<div class="prev"><span class="' + prev + '"></span></div>',
            nextArrow:
    ...
    owl_carousel = function () {
      jQuery(".owl-carousel").each(function () {
        ...
        var rtl = false;
        var prev = "bi bi-chevron-left ml-2";
        var next = "bi bi-chevron-right ml-2";
        var prev_text = "Prev";
        var next_text = "Next";
        if (jQuery("body").hasClass("pt-is-rtl")) {
          rtl = true;
          prev = "bi bi-chevron-right ml-2";
          next = "bi bi-chevron-left ml-2";
        }
        if (
